...
with col_preview:
    ...
    if not has_data:
            ...
            <table cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;">
              <tr>
                <td style="padding-right:14px;border-right:2px solid #00A74C;vertical-align:middle;">
                  <img src="data:image/png;base64,{LOGO_B64}" width="128" height="31" alt="Enable" style="display:block;">
                </td>
        ...
        # ── Copy button Option 1 ──
        sig1_html = sig_table(include_street=False).replace('\n','').replace('  ','')
        st.download_button(
        ...
        # ── Download Option 2 ──
        sig2_html = sig_table(include_street=True).replace('\n','').replace('  ','')
        st.download_button(
